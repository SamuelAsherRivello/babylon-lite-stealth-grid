...
- [x] 1.1 Record the official Tiny Swords usage and non-redistribution terms
...
- [x] 1.2 Stage the legitimate red Torch Aseprite file under the Git-ignored
...
- [x] 1.3 Export the five selected tags as transparent single-row PNGs under
...
- [x] 2.1 Add failing unit tests for idle/walking transitions, attack locking,
...
- [x] 2.2 Implement the pure common enemy state machine and goblin directional
