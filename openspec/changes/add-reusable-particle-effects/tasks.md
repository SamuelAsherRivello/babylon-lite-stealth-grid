...
- [ ] 6.7 Perform a real WebGPU browser test covering default-hidden state, each preview enabled alone, both enabled, stopped hidden animations, Reset, reload persistence, portrait resize, asset loading, and console errors; record observed results.
