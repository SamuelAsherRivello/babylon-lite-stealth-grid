...
- `actor-ai-behaviors`: Add optional whole-map bush-seeking decisions, adjacent-cell routing, and low-priority environmental attacks to goblin patrol behavior.
...
- Affects Tiled bush authoring/normalization, reactive-decoration runtime state, collider diagnostics, goblin decision/navigation integration, combat hit resolution, particle playback control, renderer layer lifecycle, and related unit/integration/browser tests.
