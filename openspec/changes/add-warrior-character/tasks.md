...
- [x] 4.1 Load Warrior atlases once and integrate Warrior creation, updates,
...
- [x] 4.2 Add a deterministic demonstration path that exercises idle, run,
...
- [x] 4.3 Run the full test/check command, production build, OpenSpec validation,
  and `git diff --check`, and verify each completes without regressions
- [x] 4.4 Inspect the running game in a real browser at desktop and portrait
