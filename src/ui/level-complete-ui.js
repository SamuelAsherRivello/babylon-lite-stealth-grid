export function createLevelCompleteUi({ host, onContinue, documentRef = globalThis.document }) {
  ...
  const title = documentRef.createElement("h2"); title.textContent = "Level Complete";
  const body = documentRef.createElement("p"); body.textContent = "You did great!";
  const button = documentRef.createElement("button");
  button.type = "button"; button.className = "level-complete-continue"; button.textContent = "Continue";
